 ...
 * @since 1.4
 */
public class OptionBrainEvaluator implements SpawnEvaluatorOption {

    /**  */
    private static final long serialVersionUID = 358315534220091144L;

    /** */
    private final BrainEvaluator brainEvaluator;

    /**
     * Constructs a new options object. 
     * 
     * @param brainEvaluator The evaluator to use.
     */
    public OptionBrainEvaluator(BrainEvaluator brainEvaluator) {
        this.brainEvaluator = brainEvaluator;
    }
     ...
     */
    public BrainEvaluator getBrainEvaluator() {
        return this.brainEvaluator;
    }
}
