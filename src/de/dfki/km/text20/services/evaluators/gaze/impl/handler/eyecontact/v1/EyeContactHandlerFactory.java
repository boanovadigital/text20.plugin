...
public class EyeContactHandlerFactory extends AbstractGazeHandlerFactory {
    public EyeContactHandlerFactory() {
        super(EyeContactListener.class, EyeContactHandlerImpl.class);
    }
}
