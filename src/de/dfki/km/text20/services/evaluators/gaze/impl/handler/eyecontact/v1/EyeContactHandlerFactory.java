...
public class EyeContactHandlerFactory implements GazeHandlerFactory {
    ...
    public Class<? extends GazeEvaluationListener<?>> getEvaluatorType() {
        return EyeContactListener.class;
    }
    ...
    public GazeHandler spawnEvaluator(GazeEvaluationListener<?> listener,
        ...
        // Create the element
        final EyeContactHandlerImpl handler = new EyeContactHandlerImpl((EyeContactListener) listener, passThrough);
