 ...
 */
@Deprecated
public interface ReadingListener extends GazeEvaluationListener<ReadingEvent> {
    /**
     * Listers must deliver the related pseudorenderer which is used to determine read position.
     * 
     * @return .
     */
