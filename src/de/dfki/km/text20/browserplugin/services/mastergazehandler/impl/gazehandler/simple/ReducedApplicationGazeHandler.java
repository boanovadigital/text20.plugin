/*
 * ReducedApplicationGazeHandler.java
 *
 ...
 * @author Ralf Biedert
 */
public class ReducedApplicationGazeHandler extends AbstractGazeHandler {
    ...
    protected void handleEvent(final EyeTrackingEvent event) {
        ...
        final List<String> handler = this.masterGazeHandler.getHandlerForType("reducedApplicationGaze");
        ...
        // Update the filter and use the filters point
